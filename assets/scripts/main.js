...
function initializeServiceWorker() {
  ...
  try {
    let registration = await navigator.serviceWorker.register("./sw.js", {scope: "/Lab7_Starter/"});
...
async function getRecipes() {
  ...
  let local_recipes = localStorage.getItem('recipes');
  if (local_recipes) {
    return JSON.parse(local_recipes);
    }
  /**************************/
